...
week1nfb = FILTER nfb by (time >= 'sun nov 04 09:00:00 pst 2012' AND time <= 'sun nov 04 23:59:59 pst 2012');
...
STORE week1nfbchi4_lim INTO 'Trending_terms_NFB_week3' USING PigStorage();
...
*
*/
week11gnfb = FILTER nfb by (time >= 'sun nov 04 09:00:00 pst 2012' AND time <= 'sun nov 04 23:59:59 pst 2012');
...
STORE week11gnfbchi4_lim INTO 'Trending_terms_NFB_week31g' USING PigStorage();
...
*
*/
week12gnfb = FILTER nfb by (time >= 'sun nov 04 09:00:00 pst 2012' AND time <= 'sun nov 04 23:59:59 pst 2012');
...
STORE week12gnfbchi4_lim INTO 'Trending_terms_NFB_week32g' USING PigStorage();
...
week13gnfb = FILTER nfb by (time >= 'sun nov 04 09:00:00 pst 2012' AND time <= 'sun nov 04 23:59:59 pst 2012');
...
STORE week13gnfbchi4_lim INTO 'Trending_terms_NFB_week33g' USING PigStorage();
