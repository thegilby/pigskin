...
week1fb = FILTER fb by time >= 'sun oct 28 09:00:00 pdt 2012' AND time <= 'sun oct 28 23:59:59 pdt 2012';
...
week1fbcompare = FILTER fb by (time >= 'sun oct 21 09:00:00 pdt 2012' AND time <= 'sun oct 21 23:59:59 pdt 2012') OR (time >= 'sun nov 04 09:00:00 pst 2012' AND time <= 'sun nov 04 23:59:59 pst 2012') OR (time >= 'sun nov 11 09:00:00 pst 2012' AND time <= 'sun nov 11 23:59:59 pst 2012') OR (time >= 'sun nov 18 09:00:00 pst 2012' AND time <= 'sun nov 18 23:59:59 pst 2012') OR (time >= 'sun nov 25 09:00:00 pst 2012' AND time <= 'sun nov 25 23:59:59 pst 2012') OR (time >= 'sun dec 02 09:00:00 pst 2012' AND time <= 'sun dec 02 23:59:59 pst 2012');
...
STORE week1fbchi4_lim INTO 'Trending_terms_FB_week2' USING PigStorage();
...
*
*/
week11gfb = FILTER fb by time >= 'sun oct 28 10:00:00 pdt 2012' AND time <= 'sun oct 28 13:35:00 pdt 2012';
...
STORE week11gfbchi4_lim INTO 'Trending_terms_FB_week21g' USING PigStorage();
...
*
*/
week12gfb = FILTER fb by time >= 'sun oct 28 13:25:00 pdt 2012' AND time <= 'sun oct 28 17:05:00 pdt 2012';
...
STORE week12gfbchi4_lim INTO 'Trending_terms_FB_week22g' USING PigStorage();
...
week13gfb = FILTER fb by time >= 'sun oct 28 17:30:00 pdt 2012' AND time <= 'sun oct 28 21:05:00 pdt 2012';
...
STORE week13gfbchi4_lim INTO 'Trending_terms_FB_week23g' USING PigStorage();
