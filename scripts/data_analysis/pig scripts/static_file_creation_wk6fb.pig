...
week1fb = FILTER fb by (time >= 'sun nov 25 09:00:00 pst 2012' AND time <= 'sun nov 25 23:59:59 pst 2012');
...
STORE week1fbchi4_lim INTO 'Trending_terms_FB_week6' USING PigStorage();
...
*
*/
week11gfb = FILTER fb by (time >= 'sun nov 25 09:00:00 pst 2012' AND time <= 'sun nov 25 23:59:59 pst 2012');
...
STORE week11gfbchi4_lim INTO 'Trending_terms_FB_week61g' USING PigStorage();
...
*
*/
week12gfb = FILTER fb by (time >= 'sun nov 25 09:00:00 pst 2012' AND time <= 'sun nov 25 23:59:59 pst 2012');
...
STORE week12gfbchi4_lim INTO 'Trending_terms_FB_week62g' USING PigStorage();
...
week13gfb = FILTER fb by (time >= 'sun nov 25 09:00:00 pst 2012' AND time <= 'sun nov 25 23:59:59 pst 2012');
...
STORE week13gfbchi4_lim INTO 'Trending_terms_FB_week63g' USING PigStorage();
