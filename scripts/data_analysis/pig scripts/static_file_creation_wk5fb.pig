...
week1fb = FILTER fb by (time >= 'sun nov 18 09:00:00 pst 2012' AND time <= 'sun nov 18 23:59:59 pst 2012');
...
STORE week1fbchi4_lim INTO 'Trending_terms_FB_week5' USING PigStorage();
...
*
*/
week11gfb = FILTER fb by (time >= 'sun nov 18 09:00:00 pst 2012' AND time <= 'sun nov 18 23:59:59 pst 2012');
...
STORE week11gfbchi4_lim INTO 'Trending_terms_FB_week51g' USING PigStorage();
...
*
*/
week12gfb = FILTER fb by (time >= 'sun nov 18 09:00:00 pst 2012' AND time <= 'sun nov 18 23:59:59 pst 2012');
...
STORE week12gfbchi4_lim INTO 'Trending_terms_FB_week52g' USING PigStorage();
...
week13gfb = FILTER fb by (time >= 'sun nov 18 09:00:00 pst 2012' AND time <= 'sun nov 18 23:59:59 pst 2012');
...
STORE week13gfbchi4_lim INTO 'Trending_terms_FB_week53g' USING PigStorage();
